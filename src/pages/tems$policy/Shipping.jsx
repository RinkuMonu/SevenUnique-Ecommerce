      ...
      <section className="tp-page-area pb-80 pt-50">
        <div className="container">
          <div className="ck-content">
            ...
            <p>
              Welcome to Finunique Small Pvt Ltd Services (hereinafter referred
              to as "Digihub Unique Tech Solutions Private Limited. Pvt Ltd").
              By signing the Service Form (hereinafter referred to as the
              "Form") and handing over your product(s) for service, you agree to
