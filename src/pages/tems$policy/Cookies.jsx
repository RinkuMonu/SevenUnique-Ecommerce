      ...
      <section className="tp-page-area pb-80 pt-50">
        <div className="container">
          <div className="ck-content">
            <h1 className="section-heading"><strong>Cookie Policy for Seven Unique Tech Solutions PVT LTD</strong></h1>
            ...
            <ul className="terms-list">
              <li>Email: <a href="mailto:infosevenunique@gmail.com">mailto:infosevenunique@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </section>
